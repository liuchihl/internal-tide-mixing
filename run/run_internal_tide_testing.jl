...
const tᶠ = 4*2π/ω₀    # endtime of the simulation
...
pickup = string("output/", simname, "/internal_tide_theta=0.0036_realtopo3D_Nx=500_Nz=250_0-2_checkpoint_iteration2291.jld2")

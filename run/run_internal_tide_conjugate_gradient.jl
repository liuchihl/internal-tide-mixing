...
include("../initialize_internal_tide_test-CG.jl")

simname = "tilt_poisson_solver"
const Nx = 500
const Ny = 1000
const Nz = 250         
const Δtᵒ = 30minutes # interval for saving output
const ω₀ = 1.4e-4     # tidal freq.
const tᶠ = 1*2π/ω₀    # endtime of the simulation: 40 tidal cycle
const θ = 0           # slope angle
const U₀ = 0.025      # tidal amplitude
const N = 1.e-3       # Buoyancy frequency
const f₀ = -0.53e-4   # Coriolis frequency
threeD_snapshot_interval = Δtᵒ  # effective only when output_mode="analysis"
closure = SmagorinskyLilly()
solver = "Conjugate Gradient"    # "FFT" or "Conjugate Gradient"
architecture = GPU()
# 4 modes to choose: "spinup", "test", "analysis", "certain-diagnostics"
output_mode = "certain-diagnostics"
output_writer = true
clean_checkpoint = true         # cleanup checkpoint
...
# pickup = string("output/", simname, "/internal_tide_theta=0.0036_realtopo3D_Nx=500_Nz=250_0-40_checkpoint_iteration64305.jld2")

...
fn1 = "output/3D_idealized_tilt_0.008/internal_tide_theta=0.008_Nx=2000_Nz=500_tᶠ=40.0_slices_xz.nc"
ds1 = Dataset(fn1, "r")
zC = ds1["z_aac"][:];
Nz = length(zC);
xC = ds1["x_caa"][:];
...
# i=145
# figure()
# scatter(ds1["x"][:,i], ds1["z"][:,i], c=ds1["ε"][:,i], cmap="viridis")
# clim()
# savefig("output/3D_idealized_tilt_0.008/particle_positions.png")
# sum(ds1["ε"][:,:])
fn2 = "output/3D_idealized_tilt_0.008/internal_tide_theta=0.008_Nx=2000_Nz=500_tᶠ=40.0_slices_xz.nc"
...
eps[eps.==0].=NaN
figure()
pcolor(xC,zC,log10.(eps)')
clim(-12,-6)
savefig("output/3D_idealized_tilt_0.008/eps_pcolor.png")




fn1 = "output/3D_idealized_tilt_0.008/internal_tide_theta=0.008_Nx=200_Nz=50_tᶠ=2.0_3Dsnapshot.nc"
fn1 = "output/3D_idealized_tilt_0.008/internal_tide_theta=0.008_Nx=200_Nz=50_tᶠ=2.0_particles_z=.nc"
fn1 = "output/3D_idealized_tilt_0.008/internal_tide_theta=0.008_Nx=200_Nz=50_tᶠ=2.0_slices_xz.nc"
# fn3 = "output/3D_idealized_tilt_0.02/internal_tide_theta=0.02_Nx=2000_Nz=500_tᶠ=200.0_snapshot.nc"
...
# quick pcolor 
# Quick pcolor plot of buoyancy field
uhat = ds1["uhat"][:, :, 1, end];
uhat[uhat.==0] .= NaN  # Mask zero values for better visualization
figure()
pcolormesh(xC, yC, uhat', shading="auto", cmap="viridis")
colorbar(label="uhat (b)")

xlabel("x (m)")
ylabel("y (m)")
show()
savefig("output/3D_idealized_tilt_0.008/initial_uhat.png")
...
y_mod = mod.(y_pos, 750)
plot(y_mod)
savefig("output/3D_idealized_tilt_0.008/particle_y_trajectory.png")
